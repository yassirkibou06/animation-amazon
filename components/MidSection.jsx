...
const MidSection = () => {
    ...
    return (
        <motion.div className="relative w-full h-full rounded-[90px] bg-black">
            ...
            <div className="z-0 absolute top-[352px] right-0 rounded-br-[120px] w-[40px] h-[80px] bg-transparent shadow-card-tp"></div>
            <div className="z-0 absolute top-[544px] right-0 rounded-tr-[120px] w-[40px] h-[80px] bg-transparent shadow-card-bt"></div>
            {/**Content */}
            <div className="absolute top-[55%] left-8 transform -translate-y-1/2 w-[500px]">
                <h2 className="font-extrabold text-white text-3xl tracking-wider mb-2">ARISEN SOUND</h2>
            ...
            {/**======= */}
            <div className="z-0 absolute top-[577px] left-0 rounded-bl-[90px] w-[88px] h-[80px] bg-transparent shadow-card-lb"></div>
            <div className="z-0 absolute top-[643px] -left-2 w-[40px] h-[100px] bg-primary shadow-overflow"></div>
