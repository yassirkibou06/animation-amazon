...
export default function Home() {
  return (
    <main className="bg-primary h-fit p-6 grid lg:grid-cols-main-lg lg:gap-8 2xl:gap-12 2xl:grid-cols-main-xl">
      {/**left section */}
      <motion.div>
        {/* input of seacrh bar */}
        <motion.form animate={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -20 }} transition={{ duration: 1.3, ease: "easeInOut" }} >
